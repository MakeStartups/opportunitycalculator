const stateNames = {
	...
	"Virginia": {
		...
		counties: {
			...
			"Charlottesville CitVA": "540",
			"Chesapeake City	": "550",
			"Clifton Forge City	": "560",
			"Colonial Heights CiVA": "570",
			"Covington City	": "580",
			"Danville City	": "590",
			"Emporia City	": "595",
			"Fairfax City	": "600",
...
const main = document.getElementById('stateDropDown');
const sub = document.getElementById('countyDropDown');
...
function showOutput(res1, res2, res3, res4, res5, res6) {
	const populationState = parseFloat(res1[1][1]);
	const populationCounty = parseFloat(res2[1][1]);
	const povertyState = parseFloat(res3[1][0]);
	...
	const investmentCounty = 6000 * disadvantagedCounty(populationCounty, povertyCounty, unemploymentCounty);
	const intFormat = new Intl.NumberFormat('en-US')
	//Display Results  
	document.getElementById('results1').innerHTML = `${intFormat.format(disadvantagedState(populationState, povertyState, unemploymentState).toFixed(0))}`;
	document.getElementById('results2').innerHTML = `${intFormat.format(survivingBusinessState(populationState, povertyState, unemploymentState).toFixed(0))}`;
	document.getElementById('results3').innerHTML = `${intFormat.format(jobsAwaitingCreationState.toFixed(0))}`;
	document.getElementById('results7').innerHTML = `$ ${intFormat.format(impactState.toFixed(0))}`;
	document.getElementById('results9').innerHTML = `$ ${intFormat.format(investmentState.toFixed(0))}`;
	document.getElementById('results4').innerHTML = `${intFormat.format(disadvantagedCounty(populationCounty, povertyCounty, unemploymentCounty).toFixed(0))}`;
	document.getElementById('results5').innerHTML = `${intFormat.format(survivingBusinessCounty(populationCounty, povertyCounty, unemploymentCounty).toFixed(0))}`;
